...
{
    "distutils": {
        "name": "transcoder.admin",
        "sources": [
            "../transcoderPanel/transcoder/admin.py"
        ]
    },
    "module_name": "transcoder.admin"
}
END: Cython Metadata */
...
#define __PYX_HAVE__transcoder__admin
#define __PYX_HAVE_API__transcoder__admin
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "transcoder.admin" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "transcoder.admin"
extern int __pyx_module_is_main_transcoder__admin;
int __pyx_module_is_main_transcoder__admin = 0;

/* Implementation of "transcoder.admin" */
...
__Pyx_RefNannySetupContext("PyInit_admin", 0);
  ...
  if (__pyx_module_is_main_transcoder__admin) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "transcoder.admin")) {
      if (unlikely((PyDict_SetItemString(modules, "transcoder.admin", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init transcoder.admin", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init transcoder.admin");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
