...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "form_filters",
        "sources": [
            "../transcoderPanel/transcoder/templatetags/form_filters.py"
        ]
    },
    "module_name": "form_filters"
}
END: Cython Metadata */
...
#define __PYX_HAVE__form_filters
#define __PYX_HAVE_API__form_filters
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char* const __pyx_f[] = {
  "transcoder/templatetags/form_filters.py",
};
...
/* Module declarations from "form_filters" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "form_filters"
extern int __pyx_module_is_main_form_filters;
int __pyx_module_is_main_form_filters = 0;

/* Implementation of "form_filters" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_12form_filters_add_class(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_field, PyObject *__pyx_v_css); /* proto */
...
#define __pyx_kp_u_transcoder_templatetags_form_fil __pyx_string_tab[2]
#define __pyx_n_u_Library __pyx_string_tab[3]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[4]
#define __pyx_n_u_add_class __pyx_string_tab[5]
#define __pyx_n_u_as_widget __pyx_string_tab[6]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[7]
#define __pyx_n_u_attrs __pyx_string_tab[8]
#define __pyx_n_u_class __pyx_string_tab[9]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[10]
#define __pyx_n_u_css __pyx_string_tab[11]
#define __pyx_n_u_django __pyx_string_tab[12]
#define __pyx_n_u_field __pyx_string_tab[13]
#define __pyx_n_u_filter __pyx_string_tab[14]
#define __pyx_n_u_form_filters __pyx_string_tab[15]
...
#define __pyx_n_u_register __pyx_string_tab[25]
...
#define __pyx_kp_b_iso88591_5_7_1 __pyx_string_tab[31]
...
/* Python wrapper */
static PyObject *__pyx_pw_12form_filters_1add_class(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_12form_filters_1add_class = {"add_class", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_12form_filters_1add_class, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_12form_filters_1add_class(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("add_class (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_field,&__pyx_mstate_global->__pyx_n_u_css,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "add_class", 0) < (0)) __PYX_ERR(0, 5, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("add_class", 1, 2, 2, i); __PYX_ERR(0, 5, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("add_class", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("form_filters.add_class", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12form_filters_add_class(__pyx_self, __pyx_v_field, __pyx_v_css);
...
static PyObject *__pyx_pf_12form_filters_add_class(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_field, PyObject *__pyx_v_css) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("add_class", 0);
...
*/
  ...
  if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_class, __pyx_v_css) < (0)) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_t_4 = 0;
  {
    ...
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_attrs, __pyx_t_3, __pyx_t_5, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 7, __pyx_L1_error)
    __pyx_t_1 = __Pyx_Object_VectorcallMethod_CallFromBuilder((PyObject*)__pyx_mstate_global->__pyx_n_u_as_widget, __pyx_callargs+__pyx_t_4, (1-__pyx_t_4) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_5);
...
static int __pyx_pymod_exec_form_filters(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_form_filters},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_form_filters(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_form_filters(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_form_filters(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'form_filters' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "form_filters" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_form_filters", 0);
  ...
  if (__pyx_module_is_main_form_filters) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "form_filters")) {
      if (unlikely((PyDict_SetItemString(modules, "form_filters", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  __pyx_t_6 = NULL;
  __pyx_t_5 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_register); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_filter); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 5, __pyx_L1_error)
  ...
  __pyx_t_7 = 1;
  {
    ...
    __Pyx_GOTREF(__pyx_t_8);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_add_class, __pyx_t_8, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
