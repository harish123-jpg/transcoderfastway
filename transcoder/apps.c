...
{
    "distutils": {
        "name": "transcoder.apps",
        "sources": [
            "../transcoderPanel/transcoder/apps.py"
        ]
    },
    "module_name": "transcoder.apps"
}
END: Cython Metadata */
...
#define __PYX_HAVE__transcoder__apps
#define __PYX_HAVE_API__transcoder__apps
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "transcoder.apps" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "transcoder.apps"
extern int __pyx_module_is_main_transcoder__apps;
int __pyx_module_is_main_transcoder__apps = 0;

/* Implementation of "transcoder.apps" */
...
#define __pyx_n_u_TranscoderConfig __pyx_string_tab[4]
...
#define __pyx_n_u_transcoder __pyx_string_tab[19]
#define __pyx_n_u_transcoder_apps __pyx_string_tab[20]
...
__Pyx_RefNannySetupContext("PyInit_apps", 0);
  ...
  if (__pyx_module_is_main_transcoder__apps) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "transcoder.apps")) {
      if (unlikely((PyDict_SetItemString(modules, "transcoder.apps", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  __pyx_t_6 = __Pyx_Py3MetaclassPrepare(__pyx_t_5, __pyx_t_2, __pyx_mstate_global->__pyx_n_u_TranscoderConfig, __pyx_mstate_global->__pyx_n_u_TranscoderConfig, (PyObject *) NULL, __pyx_mstate_global->__pyx_n_u_transcoder_apps, (PyObject *) NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 4, __pyx_L1_error)
...
*/
  ...
  /* "transcoder/apps.py":6
 * class TranscoderConfig(AppConfig):
 *     default_auto_field = 'django.db.models.BigAutoField'
 *     name = 'transcoder'             # <<<<<<<<<<<<<<
*/
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_transcoder) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     name = 'transcoder'
*/
  __pyx_t_4 = __Pyx_Py3ClassCreate(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_TranscoderConfig, __pyx_t_2, __pyx_t_6, NULL, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_4);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_TranscoderConfig, __pyx_t_4) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init transcoder.apps", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init transcoder.apps");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{29},{9},{16},{18},{18},{11},{7},{8},{13},{10},{15},{8},{4},{11},{12},{10},{8},{10},{15}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (194 bytes) */
const char* const cstring = "BZh91AY&SY=\274X\016\000\000\003_\200@\000\000\001\000\000\271\000\004\000\277\277\376\0000\000\272\266\032)\243\t\352mM\244\006\231\006\246\214\223OQ\204hz\215\001)\251\252oBF\324= \331M(6L\360m\035\357,Dt\240\301\347\032\356\222M\371\264\230\362\r\025;Fy\206\300y([\330#MlUb\216\247K\300\tt\216z\324\233\230\213\203\213\362'$'Bu!\221\233\353\211\033\316\333\026:\237%\016\347\016\313\322,*\325\356C\024\366^\245;\321\305\200\322\302\212\030\252\005\036\224Q\371\244,\320\2039dq\211<\037\000\254p\303Hn\177\213\271\"\234(H\036\336,\007\000";
...
const char* const cstring = "x\332ENA\022\3020\010\374Q\276\340Tg|\201w\206\006\332\211R\022\t\371\277ij\225\003\260\260\013\033.\364D]s\2409l\231Xj\270\246uj\236\357\211\205\246RnY\227\264>\014\265\306N\260\003GI\312\220\024\3340\362\214\361E\274`\023\007\354ZXv\361\3672\226R\001(G\350\261a\327\354\225\035\243`\255\003dj\302\243\263\014\254n\211\307Bq\3433\027\343\2026X\357\206r\014+\373\371\027\234\353\236\177F\377\335\260\360\001\000\341\\\376";
...
const char* const bytes = ".?django.db.models.BigAutoFieldAppConfigTranscoderConfigcline_in_tracebackdefault_auto_fielddjango.apps__doc____main____metaclass____module____mro_entries____name__name__prepare____qualname__setdefault__test__transcodertranscoder.apps";
    PyObject *data = NULL;
