...
{
    "distutils": {
        "name": "transcoder.tests",
        "sources": [
            "../transcoderPanel/transcoder/tests.py"
        ]
    },
    "module_name": "transcoder.tests"
}
END: Cython Metadata */
...
#define __PYX_HAVE__transcoder__tests
#define __PYX_HAVE_API__transcoder__tests
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "transcoder.tests" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "transcoder.tests"
extern int __pyx_module_is_main_transcoder__tests;
int __pyx_module_is_main_transcoder__tests = 0;

/* Implementation of "transcoder.tests" */
...
__Pyx_RefNannySetupContext("PyInit_tests", 0);
  ...
  if (__pyx_module_is_main_transcoder__tests) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "transcoder.tests")) {
      if (unlikely((PyDict_SetItemString(modules, "transcoder.tests", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init transcoder.tests", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init transcoder.tests");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
